$(function () {
	...
	$('#send-btn').click(function () {
	    ...
	    //alert($('input[name="wishaj"]').val());
	    //return false;
	        $.ajax({
	            url: $('input[name="wishaj"]').val(),
	            dataType: 'json',
                type:"POST",
                async: true,
	            ...
	            success: function (results) {
                    ...
                    {
                        var reval = '';
                        reval += "<dl class='paper a1'>";
                        reval += "                <dt>";
                        reval += "                    <span class='username'>"+ results.username +"</span>";
                        reval += "                    <span class='num'>No."+ results.id +"</span>";
                        reval += "                </dt>";
                        reval += "                <dd class='content'>"+ results.content +"</dd>";
                        reval += "                <dd class='bottom'>";
                        reval += "                    <span class='time'>"+ results.time +"</span>";
                        reval += "                    <a href=\"\" class='close'></a>";
                        reval += "                </dd>";
                        reval += "            </dl>";
                        $("#main").append(reval);
                        $("#close").click();
