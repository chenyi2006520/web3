...
<body class="overflow-hidden">
    ...
    <div class="container">
        <a href="<?php echo U('/Admin/System/addTree/');?>" class="btn btn-success col-xs-offset-11">添加一级菜单</a>
        ...
        <tbody>
            <?php if(is_array($dataList)): foreach($dataList as $key=>$val): ?><tr>
                    ...
                    <td><?php echo ($val["html"]); echo ($val["t_title"]); ?></td>
                    <td><?php echo ($val["t_sort"]); ?></td>
                    <td>
                        <?php if($val["t_pid"] == 0): ?><a href="<?php echo U('/Admin/System/addTree/',array('t_pid' => $val['id'],'t_level' => $val['t_level']));?>" class="btn btn-success">新增下一级</a>
                        <?php else: ?>
                             <a href="<?php echo U('/Admin/System/addTree/',array('t_pid' => $val['id'],'t_level' => $val['t_level']));?>" class="btn btn-default">新增下一级</a><?php endif; ?>
                        <a href="<?php echo U('/Admin/System/alterTree/', array('id' => $val['id']));?>" class="btn btn-primary">修改</a>
                        <a href="<?php echo U('/Admin/System/lockTree/', array('id' => $val['id']));?>" class="btn btn-sm btn-danger col-xs-offset-1">锁定</a>
                    </td>
