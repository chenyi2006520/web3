...
<body class="overflow-hidden">
    ...
    <?php echo BaseTreeList($treeArr);?>
                ...
                <tr>
                    ...
                    <td>
                        <select name="role_id[]" id="role_id">
                            ...
                            <?php if(is_array($roleList)): foreach($roleList as $key=>$role): ?><option value="<?php echo ($role['id']); ?>"><?php echo ($role["remark"]); ?></option><?php endforeach; endif; ?>
                        </select>
        ...
        <input type="hidden" name="roleLenght" id="roleLength" value="<?php echo ($roleLength); ?>">
