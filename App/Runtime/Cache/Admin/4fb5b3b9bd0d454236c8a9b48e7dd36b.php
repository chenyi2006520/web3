...
<body class="overflow-hidden">
    ...
    <?php echo BaseTreeList($treeArr);?>
        ...
        <form action="<?php echo U('/Admin/Bsw/handleAlterGame/');?>" method="POST" id="bsw_game_form" enctype="multipart/form-data">
            <table class="table">
                <tr>
                    <td align="center" colspan="2">修改赛事</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="g_event" id="g_event">
                            ...
                            <?php if(is_array($eventList)): foreach($eventList as $key=>$event): ?><option value="<?php echo ($event['id']); ?>" <?php echo compareValue($event["id"],$gameModel["g_event"]," selected ");?>><?php echo ($event['e_name']); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <td>
                    <input type="text" name="g_singup_s" id="g_singup_s" onFocus="singuptime(1)" value="<?php echo (date('Y-m-d H:m:s',$gameModel["g_singup_s"])); ?>" readonly/>
                </td>
            </tr>
            <tr>
                <td align="right">报名结束时间：</td>
                <td>
                    <input type="text" name="g_singup_e" id="g_singup_e" onFocus="singuptime(2)" value="<?php echo (date('Y-m-d H:m:s',$gameModel["g_singup_e"])); ?>" readonly/>
                </td>
            </tr>
                <tr>
                    <td align="right">赛事开始时间：</td>
                    <td>
                        <input type="text" name="g_time_s" id="g_time_s" value="<?php echo (date('Y-m-d H:m:s',$gameModel["g_time_s"])); ?>"   onFocus="selecttime(1)"  />
                    </td>
                </tr>
                <tr>
                    <td align="right">赛事结束时间：</td>
                    <td>
                        <input type="text" name="g_time_e" id="g_time_e" value="<?php echo (date('Y-m-d H:m:s',$gameModel["g_time_e"])); ?>"   onFocus="selecttime(2)"  />
                    </td>
                </tr>
                <tr>
                <td align="right">主办方：</td>
                <td>
                    <input type="text" name="g_sponsor" id="g_sponsor" value="<?php echo ($gameModel["g_sponsor"]); ?>" />
                </td>
            </tr>
                 <tr>
                <td align="right">报名费：</td>
                <td>
                    <input type="text" name="g_fee" id="g_fee" value="<?php echo ($gameModel["g_fee"]); ?>">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="g_amount" id="g_amount"  value="<?php echo ($gameModel["g_amount"]); ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="g_age" id="g_age" value="<?php echo ($gameModel["g_age"]); ?>">
                    </td>
                </tr>
                <tr>
                    <td align="right">星级：</td>
                    <td>
                        <input type="text" name="g_star" id="g_star" value="<?php echo ($gameModel["g_star"]); ?>">
                        <div id="starDiv"></div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="g_gps" id="g_gps" style="width:23%;" value="<?php echo ($gameModel["g_gps"]); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select name="g_gender" id="g_gender">
                            <option value="0" <?php echo compareValue(0,$gameModel["g_gender"]," selected ");?>>不限</option>
                            <option value="1" <?php echo compareValue(1,$gameModel["g_gender"]," selected ");?>>男</option>
                            <option value="2" <?php echo compareValue(2,$gameModel["g_gender"]," selected ");?>>女</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea name="g_introduction" id="g_introduction" cols="30" rows="10" ><?php echo ($gameModel["g_introduction"]); ?></textarea>
                    </td>
                </tr>
                <!--<tr>
    ...
    function initialQQMap(){
        var map = new qq.maps.Map(document.getElementById("container"),{
            center: new qq.maps.LatLng(31.853848557461927,117.25720882448513),
            zoom: 16
        });
        //绑定单击事件添加参数
        qq.maps.event.addListener(map, 'click', function(event) {
