    ...
    <div class="smart-widget widget-dark-blue">
        ...
        <div class="smart-widget-inner">
            ...
            <div class="smart-widget-body">
                <form class="form-horizontal" method="POST" action="<?php echo U('/Admin/System/handleAlterTree/');?>">
                    <div class="form-group">
                        <label for="t_Title" class="col-lg-2 control-label">菜单名称</label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" id="t_Title" name="t_Title"  value="<?php echo ($treeModel["t_title"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="t_sort" class="col-lg-2 control-label">序号</label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" id="t_sort" name="t_sort"  value="<?php echo ($treeModel["t_sort"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="t_url" class="col-lg-2 control-label">链接参数</label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control" id="t_url" name="t_url"  value="<?php echo ($treeModel["t_url"]); ?>">
                        </div>
                    </div>
                    <div class="form-group <?php echo ($hiddleValue); ?>">
                        <label class="col-lg-2 control-label">样式图标</label>
                        <div class="col-lg-10">
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio1" name="t_iconStyle" value="1" checked <?php echo compareValue('1',$treeModel['t_iconStyle']," checked ");?>>
                                    <label for="inlineRadio1"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-home fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block  col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio2" name="t_iconStyle"  value="2" <?php echo compareValue('2',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio2"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-tags fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio3" name="t_iconStyle" value="3" <?php echo compareValue('3',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio3"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-desktop fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio4" name="t_iconStyle" value="4" <?php echo compareValue('4',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio4"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa  fa-anchor fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio5" name="t_iconStyle" value="5" <?php echo compareValue('5',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio5"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-bell-o fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio6" name="t_iconStyle" value="6"  <?php echo compareValue('6',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio6"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-archive fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio7" name="t_iconStyle" value="7"  <?php echo compareValue('7',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio7"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-list fa-lg"></i></div>
                            </div>
                            <div class="radio inline-block col-xs-1">
                                <div class="custom-radio m-right-xs">
                                    <input type="radio" id="inlineRadio8" name="t_iconStyle" value="8"  <?php echo compareValue('8',$treeModel['t_iconStyle']," checked " );?>>
                                    <label for="inlineRadio8"></label>
                                </div>
                                <div class="inline-block vertical-top"><i class="block fa fa-cog fa-lg"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="t_url" class="col-lg-2 control-label">是否启用</label>
                        <div class="col-lg-3 ">
                             <div class="checkbox">
                                <label>
                                <input type="checkbox"  id="t_status" name="t_status"  value="1"  <?php echo compareValue(1,$treeModel['t_status'],'checked');?>> 启用
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="t_url" class="col-lg-2 control-label">是否前台导航</label>
                        <div class="col-lg-3 ">
                             <div class="checkbox">
                                <label>
                                <input type="checkbox"  id="t_showFlag" name="t_showFlag" value="1" <?php echo compareValue(1,$treeModel['t_showflag'],'checked');?>> 是
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <input type="hidden" value="<?php echo ($treeModel["id"]); ?>" name="id" id="id">
                            <input type="hidden" value="<?php echo ($t_pid); ?>" name="t_pid" id="t_pid">
                            <input type="hidden" value="<?php echo ($t_level); ?>" name="t_level" id="t_level">
                        </div>
                    </div>
                </form>
            </div>
