...
<body class="overflow-hidden">
    ...
    <ul class="breadcrumb">
        ...
        <div class="row">
            <a href="<?php echo U('/Admin/Bsw/addEvent');?>" class="btn btn-success col-xs-offset-11">添加赛事项目</a>
            <table class="table table-striped" id="dataTable">
                ...
                <tbody>
                    <?php if(is_array($eventList)): foreach($eventList as $key=>$val): ?><tr>
                            <td><?php echo ($val["id"]); ?></td>
                            <td><?php echo ($val["e_name"]); ?></td>
                            <td><?php echo ($val["e_sort"]); ?></td>
                            <td>
                                <a href="<?php echo U('/Admin/Bsw/alterEvent/', array('id' => $val['id']));?>" class="btn btn-primary">修改</a>
