...
<body class="overflow-hidden">
    ...
    <div class="row">
        <a href="<?php echo U('/Admin/Bsw/addMatch');?>" class="btn btn-success col-xs-offset-11">添加比赛</a>
        <table class="table table-striped" id="dataTable">
            ...
            <tbody>
                <?php if(is_array($dataList)): foreach($dataList as $key=>$val): ?><tr>
                        ...
                        <td><?php echo (date('Y-m-d',$val["m_time_s"])); ?></td>
                        <td><?php echo (date('Y-m-d',$val["m_time_e"])); ?></td>
                        <td><?php echo ($val["m_introduction"]); ?></td>
                        <td>
                            <a href="<?php echo U('/Admin/Bsw/addarticle',array('g_id' => $val['g_id'],'m_id' => $val['id'],'m_name' => $val['m_name']));?>" class="btn btn-primary">添加文章</a>
                            <a href="<?php echo U('/Admin/Bsw/alterMatch/',array('id' => $val['id']));?>" class="btn btn-primary">修改比赛</a>
