							...
							<div class="filter-bar less-bar <?php echo compareValue('1',$listModel['showMore'],'more');?>">
								<div class="filters">
									...
									<?php if($listModel['year'] != 'all'): ?><div class="filter js-less less-item clearfix" style="border:0"><span class="tit"></span>
											...
											<?php $__FOR_START_1359833954__=1;$__FOR_END_1359833954__=13;for($i=$__FOR_START_1359833954__;$i < $__FOR_END_1359833954__;$i+=1){ ?><span class="word <?php echo compareValue($i,$listModel['month'],'active');?>">
