...
return array( 
    ...
    'URL_ROUTE_RULES'=>array(
        ...
        //www.test003.com/game/橄榄球/湖南/长沙/2014/6        
        
        // 此顺序不能更改
        'games$'  => 'Bsw/index',        
        // 'game/:type/:province/:city/:year\d/:month\d$' => 'Bsw/index?type=:1&=province=:2&=city=:3&=year=:4&=month=:5',//包含赛事搜索所有url条件
        // 'game/:type/:province/:city/:year$' => 'Bsw/index?type=:1&=province=:2&=city=:3&=year=:4',//类型省市年份
        // 'game/:type/:province/:year\d$' => 'Bsw/index?type=:1&=province=:2&=year=:3',//类型省年份
        // 'game/:type/:province/:city$' => 'Bsw/index?type=:1&=province=:2&=city=:3',//类型省市
        ...
        // 'game/:type$' => 'Bsw/index?type=:1&=province=all',//类型
